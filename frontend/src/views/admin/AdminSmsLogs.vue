<template>
  <div class="panel">
    <div class="panel-header">
      <span class="panel-title">簡訊發送紀錄</span>
...
.dk { font-weight: 600; color: #64748b; min-width: 80px; flex-shrink: 0; }
.dv { color: #1e293b; word-break: break-all; }
.error-text { color: #dc2626; }

.detail-section { margin-top: 0.75rem; }
.ds-title { font-size: 0.78rem; font-weight: 600; color: #64748b; margin-bottom: 0.35rem; }
.json-pre {
  background: #f8fafc;
