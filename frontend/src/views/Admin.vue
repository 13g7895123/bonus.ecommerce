...
import { Users, ShieldCheck, Coins, FileEdit, Gift, ShoppingBag, TicketPercent, Home, ChevronLeft, ChevronRight, Smartphone, MessageSquare, Building2, Mail, Megaphone, BadgeCheck, CalendarCheck2 } from 'lucide-vue-next'
...
const navItems = [
  ...
  { key: 'skywards-benefits', label: 'Skywards 權益頁', icon: BadgeCheck },
  ...
  { key: 'sign-in-records',  label: '每日簽到紀錄',  icon: CalendarCheck2 },
