...
import { Activity, Globe, BarChart2, Home, ChevronLeft, ChevronRight, Shield, MessageSquare, MessageCircle, ShieldAlert } from 'lucide-vue-next'
...
const navItems = [
  ...
  { key: 'sms-settings',     label: 'SMS 防濫用設定',   icon: ShieldAlert },
